...
\begin{column}{\colwidth}
  ...
  \begin{psection}{Results}
    ...
    \begin{center}
      \begin{tikzpicture}
        \begin{axis}[posterchart, width=0.9\linewidth, height=13cm,
          ybar, bar width=1.7cm, enlarge x limits=0.32,
          title={Pose AUC@5 vs.\ number of input views},
    ...
    \end{center}
    \vskip1.0ex
    % ---- gain chart + results table side by side ----
    \begin{minipage}[c]{0.52\colwidth}
      \centering
      \begin{tikzpicture}
        \begin{axis}[posterchart, height=9.5cm,
          ybar, bar width=1.2cm, enlarge x limits=0.2,
